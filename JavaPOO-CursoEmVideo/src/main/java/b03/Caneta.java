...
public class Caneta {
    ...
    public String cor;
    private Float ponta; // Com float não será possível comparar com null no método status()
    protected Integer carga; // Com int não será possível comparar com null no método status()
